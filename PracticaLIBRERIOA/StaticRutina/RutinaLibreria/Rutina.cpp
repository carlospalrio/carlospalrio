...
namespace MathLibrary
{
    ...
    void Funciones::Calorias(string Sport) {
        if (Sport == "Boxeo") {
            ...
            cout << "              Durante estos 10 rounds de saco quemaras aproximadamente 300 calorias\n"; Sleep(500);
            ...
            cout << "                        Durante este entrenamiento quemaras unas 250 calorias.\n"; Sleep(500);
        }
            ...
            cout << "                        Durante este entrenamiento quemaras unas 180 calorias.\n"; Sleep(500);
        }
        Sleep(500);
        system("CLS");
    }
